...
# print(text_number)
def generate_batch_data(sentences, batch_size, window_size, method='cbow'):
    # Fill up data batch
    batch_data = []
    label_data = []
    while len(batch_data) < batch_size:
        ...
        if method=='cbow':
            ...
            # print('batch_and_label',batch_and_labels)
...
# aa, bb = generate_batch_data(text_number, batch_size, window_size)
# print('batch_data = ',aa,'\nlabel_data = ',bb)
...
for i in range(window_size*2):
    embed += tf.nn.embedding_lookup(embeddings, x_inputs[:,i])
